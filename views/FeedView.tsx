...
const FeedView: React.FC<{ user: User }> = ({ user }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10 animate-fadeIn">
      {/* Creation Protocol */}
      <div className="glass-effect rounded-[2.5rem] p-6 md:p-10 border border-white/10 shadow-2xl relative overflow-hidden group">
            ...
            <React.Fragment key={post.id}>
              ...
              <div className="glass-effect rounded-[2.8rem] overflow-hidden border border-white/5 group hover:border-white/10 transition-all shadow-xl">
                <div className="p-8 md:p-10">
                  <div className="flex items-center justify-between mb-8">
                    <Link to={`/profile/${post.authorId}`} className="flex items-center gap-4 group/author">
                      ...
                      <div>
                        ...
                        <span className="text-[9px] text-slate-500 uppercase tracking-[0.3em] font-bold mt-1 block">Level: {post.authorRole || 'User'}</span>
                      </div>
                    </Link>
                  ...
                  {post.imageUrl && (
                    <div className="rounded-[2rem] overflow-hidden border border-white/5 bg-slate-950 mt-8 relative group/img">
