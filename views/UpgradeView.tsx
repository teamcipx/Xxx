...
const UpgradeView: React.FC<{ activeUser: User }> = ({ activeUser }) => {
  ...
  if (activeUser.role === 'pro' || activeUser.role === 'admin') {
    return (
      <div className="max-w-xl mx-auto glass-effect rounded-[2.5rem] p-12 text-center space-y-6 border border-amber-500/20 shadow-2xl animate-fadeIn">
        ...
        <p className="text-slate-400 font-medium">You are already a Pro Member. All exclusive channels and features are unlocked for your signal.</p>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-fadeIn">
      <div className="text-center space-y-4">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto font-medium">Unlock the full potential of Akti Forum. Manual verification ensures the highest security for our elite citizens.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="glass-effect rounded-[2.5rem] p-8 border border-white/5 space-y-8">
          <div>
            ...
            <p className="text-slate-500 text-xs mt-2 font-medium">Please transfer <span className="text-white font-bold">$9.99 USD</span> to the official Akti wallet.</p>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-slate-950/60 p-5 rounded-2xl border border-white/5 group">
              ...
              <div className="flex items-center justify-between">
                <code className="text-indigo-300 font-mono text-sm">AKT-FORUM-OFFICIAL-01</code>
                <button onClick={() => navigator.clipboard.writeText('AKT-FORUM-OFFICIAL-01')} className="text-slate-500 hover:text-white transition-colors">
